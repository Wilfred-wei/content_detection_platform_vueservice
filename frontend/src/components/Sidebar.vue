<template>
  <aside class="sidebar">
    ...
    <ul>
      <li>
        <router-link to="/rumor_detection/">图文谣言检测</router-link>
      </li>
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" @click="toggleDropdown" :class="{ active: showDropdown }">
          视频分析
        </a>
        <ul class="submenu" :class="{ show: showDropdown }">
          <li><router-link to="/video_analysis/module1/">视听平台不良内容检测系统</router-link></li>
          <li><router-link to="/video_analysis/module2/">智能摘要系统</router-link></li>
          <li><router-link to="/video_analysis/module3/">不良视频检测数据集</router-link></li>
        </ul>
      </li>
      <li>
        <router-link to="/detection-agent/image/">AI 检测对话</router-link>
      </li>
    </ul>
  </aside>
</template>
...
.sidebar .submenu li:hover {
  background: rgba(59, 135, 216, 0.1);
