  ...
  <div class="page-layout">
    ...
    <main class="layout-main">
        <div class="content-area">
          ...
          基于先进AI技术的视听平台不良内容检测系统，对上传视频分析并给出其潜在危害类型，置信度越接近100表示越可能具有此类危害。
          </div>
      ...
      exampleVideos: [
        {
          ...
          title: '未成年不良视频',
          description: '包含未成年人不良行为或易对未成年人造成负面影响的不良视频',
          type: 'fake'
        },
        {
          filename: 'example3_2_1_PHSHWD.mp4',
          title: '破坏社会稳定视频',
          description: '捏造，鼓动，宣传反党反社会言论思想与行为的不良视频',
          type: 'fake'
        },
        {
          filename: 'example3_2_1_SQDS.mp4',
          title: '色情低俗视频',
          description: '包含擦边色情性暗示等信息的不良视频',
          type: 'fake'
        },
        {
          filename: 'example3_2_1_XXBL.mp4',
          title: '血腥暴力视频',
          description: '包含血腥，暴力，猎奇等引起用户观感不适的不良视频',
          type: 'fake'
        },
        {
          filename: 'example3_2_1_DBZP.mp4',
          title: '赌博诈骗视频',
          description: '宣传赌博诈骗相关信息或引诱用户参与赌博诈骗行为的不良视频',
          type: 'fake'
        },
        {
          filename: 'example3_2_1_WGYX.mp4',
          title: '违规营销视频',
          description: '通过虚假宣传等手段欺骗误导消费者购买使用其产品的不良视频',
          type: 'fake'
        }
      ],
      currentPage: 1,
